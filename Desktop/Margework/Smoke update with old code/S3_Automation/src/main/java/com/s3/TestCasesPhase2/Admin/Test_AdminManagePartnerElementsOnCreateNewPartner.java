...
public class Test_AdminManagePartnerElementsOnCreateNewPartner {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 9, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verification of Element after create new partner in table");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_09");
	...
	public void ManagePartnerElementOnCreateNewPartner(String Username, String Password, String NewPartnerName) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
		//	AdminPhase2.CreatePartner(NewPartnerName);
			Result = AdminPhase2.ElementVerificationofTable(NewPartnerName);
			AdminPhase2.DeletePartner(NewPartnerName);
			System.out.println("Verification of Element after create new partner in table  " + Result);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERELEMENTCHECKONPROFILE;
