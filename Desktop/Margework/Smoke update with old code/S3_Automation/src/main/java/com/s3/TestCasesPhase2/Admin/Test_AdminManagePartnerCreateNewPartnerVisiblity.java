...
public class Test_AdminManagePartnerCreateNewPartnerVisiblity {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 3, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify Create new partner popup visiblity");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_03");
	...
	public void ManagePartnerNewPartnervisiblity(String Username, String Password) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
			Result = AdminPhase2.ManagePartner_CreateNewPartner_PopupVisiblity();
			System.out.println("Create new user popup visiblity verification is  " + Result);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERCREATENEWPARTNERPOPUP;
