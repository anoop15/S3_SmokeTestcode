...
public class Test_AdminManagePartnerPrefilledNameOnEditPartner {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 16, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify prifill Name on Edit partner");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_16");
	...
	public void ManagePartnerPrefillNameEditPartner(String Username, String Password) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
			Result = AdminPhase2.ManagePartner_PrefilledNameOnEditPartnerPopup();
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERPREFILLNAME;
