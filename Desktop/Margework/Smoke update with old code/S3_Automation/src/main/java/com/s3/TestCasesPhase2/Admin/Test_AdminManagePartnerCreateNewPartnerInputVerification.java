...
public class Test_AdminManagePartnerCreateNewPartnerInputVerification {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 6, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify input functionality in Name fields on Create New Partner popup ");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_06");
	...
	public void ManagePartnerInputinName(String Username, String Password, String inputText) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
			Result = AdminPhase2.ManagePartner_CreateNewPartner_InputtextVerification(inputText);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERCREATENEWPARTNERNAMEINPUT;
