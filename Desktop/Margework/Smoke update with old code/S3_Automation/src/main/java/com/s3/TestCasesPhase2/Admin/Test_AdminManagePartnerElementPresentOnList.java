...
public class Test_AdminManagePartnerElementPresentOnList {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 14, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify Edit and Delete link on each partner in list");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_14");
	...
	public void ManagePartnerVerifyElementForPartnerList(String Username, String Password) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			...
			Thread.sleep(4000);
			Result= AdminPhase2.ElementVerificationOnList();
			System.out.println("Edit and Delete button verification is" + Result);
			ExcelUtils.wrtExcelData(14, Constant.RESULT_COL+ ResultCol, statusExcel, statusSheet, Result);
			ResultCol++;
			ExcelUtils.wrtExcelData(14, Constant.RESONE_COL, statusExcel, statusSheet,"");
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERELEMENTOFALLPARTNER;
