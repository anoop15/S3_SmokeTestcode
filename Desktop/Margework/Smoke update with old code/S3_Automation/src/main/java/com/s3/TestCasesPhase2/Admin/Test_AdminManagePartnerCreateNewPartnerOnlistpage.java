...
public class Test_AdminManagePartnerCreateNewPartnerOnlistpage {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 10, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify functionality of create new partner display in Partner list");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_10");
