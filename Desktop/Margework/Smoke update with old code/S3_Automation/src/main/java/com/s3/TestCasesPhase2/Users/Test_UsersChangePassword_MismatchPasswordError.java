...
public class Test_UsersChangePassword_MismatchPasswordError {
	...
	public void Setup() throws Exception {
		String runMode= LoginPhase2.Runable(2, 2, 16, 3, Constant.RUNMODEUSER);
		if(runMode.equals("N"))	{
		...
		System.out.println("*****Password and confirm passoword error message Verification*****");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("Error message on mismatch password, TC_User_16");
	...
	public void SearchUserVerification(String username, String password, String rememberme,String searchText,String newPassword, String confirmPassword) throws Exception {
		...
		try {
			...
			Result=UserProfilePhase2.mismatchchangePassword(searchText,newPassword,confirmPassword);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.CHANGEPASSWORDINVALIDINPUT;
