...
public class Test_UsersCreateNewUser_UI_verification {
	...
	public void Setup() throws Exception {
		String runMode= LoginPhase2.Runable(2, 2, 3, 3, Constant.RUNMODEUSER);
		if(runMode.equals("N"))	{
		...
		System.out.println("Validte the UI of Create User popup");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("UI_Verification of Create User, TC_User_03 ");
	...
	public void NewUserUIVerification(String username, String password, String rememberme, String LoggedinUsertype ,String partner, String client) throws Exception {
		...
		try {
			...
			Result = UserProfilePhase2.UI_Verification_CreateNewUser(LoggedinUsertype,partner,client);
			ExcelUtils.wrtExcelData(3, Constant.RESULT_COL + ResultCol, statusExcel, statusSheet, Result);
			ResultCol++;
			Assert.assertEquals(Result, "Pass");
			System.out.println("Create New user popup display and all fields are showing");

		} catch (Exception e) {
			Log.info("Create new user popup UI fields verification fail");
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.UI_NEWUSERPOPUP;
