...
public class Test_AdminManagePartnerEditPartnerfunctionality {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 17, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify Edit partner Name functionality");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_17");
	...
	public void ManagePartnerEditPartner(String Username, String Password ,String oldName, String newName) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
			Result = AdminPhase2.ManagePartner_EditPartnerName(oldName,newName);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNEREDITPARTNERNAME;
