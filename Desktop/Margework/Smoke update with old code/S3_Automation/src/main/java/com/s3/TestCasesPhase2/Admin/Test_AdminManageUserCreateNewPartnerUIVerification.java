...
public class Test_AdminManageUserCreateNewPartnerUIVerification {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 4, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify Create new partner popup UI verification");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_04");
	...
	public void ManagePartnerNewPartnerUI(String Username, String Password) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
			Result = AdminPhase2.ManagePartner_CreateNewPartner_PopupUIVerification();
			System.out.println("Create new user popup UI verification is  " + Result);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERCREATENEWPARTNERPOPUPUI;
