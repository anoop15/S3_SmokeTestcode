...
public class Test_UsersChangePassword_MendetoryFields {
	...
	public void Setup() throws Exception {
		String runMode= LoginPhase2.Runable(2, 2, 15, 3, Constant.RUNMODEUSER);
		if(runMode.equals("N"))	{
		...
		System.out.println("*****Change Password Required fields Verification*****");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("Search user, TC_User_15");
	...
	public void SearchUserVerification(String username, String password, String rememberme,String searchText) throws Exception {
		...
		try {
			...
			Result=UserProfilePhase2.changePasswordRequiredFields(searchText);
			ExcelUtils.wrtExcelData(15, Constant.RESULT_COL + ResultCol, statusExcel, statusSheet, Result);
			ResultCol++;
			Assert.assertEquals(Result, "Pass");
			System.out.println(searchText + " All mendetory fields shows red boxs on leave blank");
			} catch (Exception e) {
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		//Using TC_User_14 data sheet which we used for TC_User_14 test case.
