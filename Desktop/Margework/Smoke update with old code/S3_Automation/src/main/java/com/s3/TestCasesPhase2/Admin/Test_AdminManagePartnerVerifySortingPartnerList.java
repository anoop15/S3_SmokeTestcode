...
public class Test_AdminManagePartnerVerifySortingPartnerList {
	...
	public void Setup() throws Exception {
		...
		String runMode= BaseLogic.Runable(3, 2, 11, 3, Constant.RUNMODEADMIN);
		if(runMode.equals("N"))	{
		...
		System.out.println("Verify sorting of Partner list");
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TC_Admin_11");
	...
	public void ManagePartnerCreateNewPartner(String Username, String Password) throws FileNotFoundException {
		String Result ="Fail";
		try {
			Thread.sleep(1000);
			LoginPhase2.Login(Username, Password);
			Thread.sleep(2000);
			Result = AdminPhase2.SortingPartnerList();
			System.out.println("Sorting order of paartner list is  " + Result);
	...
	public Object[][] dataProviderMethod() throws Exception {
		...
		String strQuery = "Select * from " + Constant.MANPARTNERLISTSORTING;
