...
public class TCAddCampusJobModule {

	public static int mRow;
	public static int mCol;

	String excelFile = Constant.EXCEL_FILE_NAME;
	String excelSheetName = Constant.ADD_CAMPUSJOBMODULE_SHEET;
	String filepath = Constant.REPORTS_CAMPUSJOBMODULE_FILE;
	ExtentReports extent = ExtentReports.get(TCAddCampusJobModule.class);

	@SuppressWarnings("deprecation")
	@BeforeMethod()
	public void logConfi() throws Exception {
		DOMConfigurator.configure("log4j.xml");
		Log.startTestCase("TCAddCampusJobModule");
		Utils.OpenBrowser(Constant.BROWSER_NAME, Constant.URL);
		extent.init(filepath, true);
		extent.startTest("TCAddCampusJobModule", "S3 TCAddCampusJobModule Test Started");
	...
	public void addPreDefinedWebModule() throws Exception {
		...
		try {
			...
			extent.log(LogStatus.PASS, "TCAddCampusJobModule", "Test Pass");
			...
			ExcelUtils.wrtExcelData(121, 3, statusExcel, statusSheet, "Pass");
			...
			try {
				...
				String statusExcel = Constant.STATUS_EXCEL_FILE;
				String statusSheet = Constant.STATUS_SHEET;
				ExcelUtils.wrtExcelData(121, 6, statusExcel, statusSheet, "Fail");
			...
			e.getMessage();
			extent.log(LogStatus.FAIL, "TCAddCampusJobModule", "Test Fail");
		}
	}
